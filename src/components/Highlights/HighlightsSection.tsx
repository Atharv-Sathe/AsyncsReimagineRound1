...
function HighlightsSection({isSmall} : {isSmall: boolean}) {
    return (
        <section id="highlights-section" className={`${isSmall  ? "w-full flex flex-col justify-center items-center h-fit"  : "relative w-[55%] h-[50vh]"}`}>
            ...
            <div id="carousel-content" className={`${isSmall  ? "h-[15vh] w-[70vw] mt-10"  : "relative z-10 left-[20%] top-24 h-[35vh] w-[65%]"}  text-white rounded-md`}>
