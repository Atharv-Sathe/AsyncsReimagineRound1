    ...
    return (
        <section id="hero-section" className="text-left text-white absolute bottom-48 left-20 w-1/2">
            <div id="wrapper" >
                ...
                <h2 id="hero-descrip" className=" fadeInSlideUp-medium  text-2xl mt-4">Government of India</h2>
            </div>

            <button id="learn-more-btn"  className="fadeInSlideUp-slow  mt-4  p-4 border-2">Learn More</button>
        </section>
    );
}
